...
public class GameEngineEntity extends BasicFormObject implements BasicObjectInterface {
    ...
    public GameEngineEntity() {
    }

    public GameEngineEntity(@Deserialize("created") Date created,
